...
<!-- BEGIN Java Script for this page -->
<script src='"""),_display_(/*236.15*/routes/*236.21*/.Assets.versioned("js/pagesJS/sidebar.js")),format.raw/*236.63*/("""'></script>
<!-- END Java Script for this page -->
